...
import {
  ...
  promptForAccountCredentials,
  confirmOverwriteCredentials,
} from "./prompts.js";
...
export async function promptAndStoreCredentials(
  ...
  if (existingCredentials) {
    ...
    console.log(
      chalk.yellow(`   Current Account ID: ${currentCredentials.accountId}`),
    );
    console.log(
      chalk.yellow(
    ...
    console.log(
      chalk.yellow(
        `   as they will no longer be stored in the CLI after setting new credentials.`,
      ),
    );
    console.log("");
